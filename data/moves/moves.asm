...
Moves1:
	...
	move EFFECT_MULTI_HIT,          15, FAIRY,          95, 10,   0      ;DOUBLESLAP
	move EFFECT_ATTACK_UP_HIT,     100, STEEL,          85, 10,  20      ;COMET_PUNCH
	move EFFECT_NORMAL_HIT,         80, NORMAL,         85, 20,   0      ;MEGA_PUNCH
	move EFFECT_RECOIL_HIT,        120, STEEL,         100,  5,   0      ;PAY_DAY
	...
	move EFFECT_NORMAL_HIT,         75, BUG,           100, 20,   0      ;VICEGRIP
	move EFFECT_OHKO,                0, STEEL,          30,  5,   0      ;GUILLOTINE
	move EFFECT_NORMAL_HIT,         70, FLYING,        100, 15,   0      ;RAZOR_WIND
	...
	move EFFECT_SLAM,               60, NORMAL,        100, 20,   0      ;SLAM
	...
	move EFFECT_JUMP_KICK,          85, FIGHTING,       95, 25,   0      ;JUMP_KICK
	...
	move EFFECT_POISON_MULTI_HIT,   40, BUG,           100, 20,  20      ;TWINEEDLE
	move EFFECT_MULTI_HIT,          20, BUG,            85, 20,   0      ;PIN_MISSILE
	...
	move EFFECT_FORCE_SWITCH,        0, DRAGON,        100, 20,   0      ;ROAR
	...
	move EFFECT_SPEED_DOWN_HIT,     60, FIGHTING,      100, 15, 100      ;LOW_KICK
	move EFFECT_COUNTER,             1, FIGHTING,      100, 20,   0      ;COUNTER
	move EFFECT_NORMAL_HIT,         80, FIGHTING,      100, 15,   0      ;STRENGTH
	move EFFECT_LEECH_HIT,          25, GRASS,         100, 20,   0      ;ABSORB
	move EFFECT_LEECH_HIT,          50, GRASS,         100, 10,   0      ;MEGA_DRAIN
	...
	move EFFECT_RAMPAGE,            90, GRASS,         100, 20,   0      ;PETAL_DANCE
	move EFFECT_ATTACK_DOWN_HIT,    60, DRAGON,        100, 15, 100      ;DRAGON_RAGE
	...
	move EFFECT_BATON_PASS,          0, PSYCHIC_TYPE,  100, 20,   0      ;TELEPORT
	...
	move EFFECT_DEFENSE_UP,          0, ROCK,          100, 30,   0      ;HARDEN
	move EFFECT_EVASION_UP,          0, NORMAL,        100, 20,   0      ;MINIMIZE
	move EFFECT_ACCURACY_DOWN,       0, FIRE,          100, 20,   0      ;SMOKESCREEN
	...
	move EFFECT_DEFENSE_UP_2,        0, STEEL,         100, 30,   0      ;BARRIER
	...
	move EFFECT_SELFDESTRUCT,      200, ELECTRIC,      100,  5,   0      ;SELFDESTRUCT
	move EFFECT_PARALYZE_HIT,       20, GHOST,         100, 30,  30      ;LICK
	move EFFECT_POISON_HIT,         40, POISON,         90, 20,  40      ;SMOG
	...
	move EFFECT_PRIORITY_HIT,       40, FLYING,        100, 30,   0      ;SWIFT
	move EFFECT_SKULL_BASH,        120, ROCK,          100, 15,   0      ;SKULL_BASH
	move EFFECT_MULTI_HIT,          20, POISON,        100, 15,   0      ;SPIKE_CANNON
	move EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE,  100, 20,   0      ;AMNESIA
	move EFFECT_JUMP_KICK,         100, FIGHTING,       90, 20,   0      ;HI_JUMP_KICK
	move EFFECT_PARALYZE,            0, DARK,          100, 30,   0      ;GLARE
	move EFFECT_DREAM_EATER,       100, GHOST,         100, 15,   0      ;DREAM_EATER
	move EFFECT_POISON,              0, POISON,         90, 40,   0      ;POISON_GAS
	move EFFECT_MULTI_HIT,          15, GRASS,         100, 30,   0      ;BARRAGE
	...
	move EFFECT_ACCURACY_DOWN_HIT,  20, FAIRY,         100, 10, 100      ;FLASH
	...
	move EFFECT_SELFDESTRUCT,      200, FIRE,          100,  5,   0      ;EXPLOSION
	move EFFECT_MULTI_HIT,          18, DARK,          100, 15,   0      ;FURY_SWIPES
	move EFFECT_HEAL,                0, PSYCHIC_TYPE,  100, 10,   0      ;REST
	move EFFECT_FLINCH_HIT,         80, ROCK,          100, 10,  30      ;ROCK_SLIDE
	move EFFECT_FLINCH_HIT,         80, NORMAL,         90, 15,  10      ;HYPER_FANG
	move EFFECT_ATTACK_UP,           0, ROCK,          100, 30,   0      ;SHARPEN
	...
	move EFFECT_THIEF,              50, DARK,          100, 10, 100      ;THIEF
	move EFFECT_LOCK_ON,             0, PSYCHIC_TYPE,  100,  5,   0      ;MIND_READER
	...
	move EFFECT_CURSE,               0, GHOST,         100, 10,   0      ;CURSE
	move EFFECT_REVERSAL,            1, NORMAL,        100, 15,   0      ;FLAIL
	move EFFECT_FLINCH_HIT,        100, FLYING,         85, 10,  20      ;AEROBLAST
	...
	move EFFECT_SPEED_DOWN_2,        0, DARK,           90, 10,   0      ;SCARY_FACE
	move EFFECT_ALWAYS_HIT,         70, DARK,          100, 20,   0      ;FAINT_ATTACK
	...
	move EFFECT_ACCURACY_DOWN_HIT,  85, WATER,          95, 10,  50      ;OCTAZOOKA
	move EFFECT_SPIKES,              0, GROUND,        100, 20,   0      ;SPIKES
	move EFFECT_ZAP_CANNON,        100, ELECTRIC,       50,  5, 100      ;ZAP_CANNON
	move EFFECT_FORESIGHT,           0, FIGHTING,      100, 40,   0      ;FORESIGHT
	move EFFECT_DESTINY_BOND,        0, GHOST,         100,  5,   0      ;DESTINY_BOND
	move EFFECT_PERISH_SONG,         0, GHOST,         100,  5,   0      ;PERISH_SONG
	move EFFECT_SPEED_DOWN_HIT,     60, ICE,           100, 15, 100      ;ICY_WIND
	move EFFECT_PROTECT,             0, FIGHTING,      100,  5,   0      ;DETECT
	move EFFECT_MULTI_HIT,          25, GROUND,         80, 10,   0      ;BONE_RUSH
	move EFFECT_LOCK_ON,             0, STEEL,         100,  5,   0      ;LOCK_ON
	...
	move EFFECT_SWAGGER,             0, DARK,           90, 15, 100      ;SWAGGER
	...
	move EFFECT_DEFENSE_UP_HIT,     75, STEEL,          95, 25,  10      ;STEEL_WING
	move EFFECT_MEAN_LOOK,           0, DARK,          100,  5,   0      ;MEAN_LOOK
	move EFFECT_ATTRACT,             0, FAIRY,         100, 15,   0      ;ATTRACT
	move EFFECT_SLEEP_TALK,          0, NORMAL,        100, 10,   0      ;SLEEP_TALK
	move EFFECT_HEAL_BELL,           0, FAIRY,         100,  5,   0      ;HEAL_BELL
	...
	move EFFECT_SP_ATK_DOWN_HIT,    75, FIRE,          100, 10, 100      ;SACRED_FIRE
	move EFFECT_MAGNITUDE,           1, GROUND,        100, 30,   0      ;MAGNITUDE
	move EFFECT_CONFUSE_HIT,       120, FIGHTING,       50,  5, 100      ;DYNAMICPUNCH
	move EFFECT_NORMAL_HIT,        120, BUG,            85, 10,   0      ;MEGAHORN
	move EFFECT_PARALYZE_HIT,       90, DRAGON,        100, 20,  30      ;DRAGONBREATH
	...
	move EFFECT_EVASION_DOWN,        0, GRASS,         100, 20,   0      ;SWEET_SCENT
	move EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,          85, 15,  30      ;IRON_TAIL
	move EFFECT_ATTACK_UP_HIT,      60, STEEL,          95, 35,  10      ;METAL_CLAW
	...
	move EFFECT_ALL_UP_HIT,         65, ROCK,          100,  5,  10      ;ANCIENTPOWER
	move EFFECT_SP_DEF_DOWN_HIT,    90, GHOST,         100, 15,  20      ;SHADOW_BALL
	...
	move EFFECT_NORMAL_HIT,         60, BUG,           100, 20,   0      ;BUG_BITE
	...
	move EFFECT_DOUBLE_HIT,         50, STEEL,          90, 10,   0      ;GEAR_GRIND
	move EFFECT_HYPER_BEAM,        150, WATER,          90,  5,   0      ;HYDRO_CANNON
	move EFFECT_ROLLOUT,            30, ICE,            90, 20,   0      ;ICE_BALL
	move EFFECT_FLINCH_HIT,         70, STEEL,         100, 15,  30      ;IRON_HEAD
	move EFFECT_NORMAL_HIT,        100, NORMAL,        100, 35,   0      ;JUDGEMENT
	move EFFECT_SP_DEF_DOWN_2,       0, STEEL,          85, 20,   0      ;METAL_SOUND
	move EFFECT_SP_DEF_DOWN_HIT,    90, FAIRY,         100, 15,  10      ;MOONBLAST
	move EFFECT_ACCURACY_DOWN_HIT,  65, GROUND,         85, 10,  30      ;MUD_BOMB
	move EFFECT_SP_ATK_UP_2,         0, DARK,          100, 20,   0      ;NASTY_PLOT
	move EFFECT_FLINCH_HIT,         80, GRASS,         100, 15,  20      ;NEEDLE_ARM
	move EFFECT_ATTACK_DOWN_HIT,   100, FAIRY,          90, 10,  20      ;PLAY_ROUGH
	move EFFECT_NORMAL_HIT,         90, FIGHTING,      100, 15,   0      ;SACRED_SWORD
	move EFFECT_TRAP_TARGET,        35, GROUND,         85, 15,   0      ;SAND_TOMB
	move EFFECT_RECOIL_HIT,        110, DRAGON,         90,  5,   0      ;SCALE_SCRAPE
	move EFFECT_ALWAYS_HIT,         70, GHOST,         100, 20,   0      ;SHADOW_PUNCH
	move EFFECT_ALL_UP_HIT,         65, BUG,           100,  5,  10      ;SILVER_WIND
	move EFFECT_BURN_HIT,          110, WATER,          95,  5,  30      ;STEAM_ERUPT
